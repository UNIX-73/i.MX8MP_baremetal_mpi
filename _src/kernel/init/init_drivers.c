...
static void uart_stage0_() { UART_init_stage0(&UART2_DRIVER); }
...
static void tmu_stage1_() { TMU_init_stage1(&TMU_DRIVER); }
...
static void agt_stage0_() { AGT_init_stage0(&AGT0_DRIVER); }
